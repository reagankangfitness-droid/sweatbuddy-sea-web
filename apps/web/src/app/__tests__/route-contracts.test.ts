...
describe('route contracts', () => {
  it('keeps the public homepage centered on city-guide discovery with events as the live layer', () => {
    ...
    expect(homePage).toContain('active="places"')
    expect(homePage).toContain('Fitness in Singapore.')
    expect(homePage).toContain('Find where to show up, who it suits, and the easiest path to join.')
    expect(homePage).toContain('PlaceCoverImage')
    expect(homePage).toContain('Curated show-up guide')
    expect(homePage).toContain('Places where joining makes sense')
    expect(homePage).toContain('Live social layer')
    expect(homePage).toContain('Upcoming plans at and around these places')
    ...
    expect(homePage).toContain('Start a plan')
    expect(homePage).toContain('Explore Singapore guide')
    ...
    expect(homePage).toContain('/singapore/run-clubs')
    ...
    expect(cityGuideTabs).toContain("href: '/singapore'")
    expect(cityGuideTabs).toContain("href: '/buddy?city=singapore'")
    expect(cityGuideTabs).toContain("href: '/communities?city=singapore'")
    expect(cityGuideTabs).toContain("href: '/buddy?view=map&city=singapore'")
    ...
    expect(createChoiceSheet).toContain('Start a plan')
