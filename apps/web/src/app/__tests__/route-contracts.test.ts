...
describe('route contracts', () => {
  it('keeps the public homepage centered on city-guide discovery with events as the live layer', () => {
    ...
    expect(homePage).toContain('Fitness plans where showing up solo feels normal.')
    expect(homePage).toContain('Find nearby runs, classes, games, and recovery sessions')
    ...
    expect(buddyPage).toContain('Find a plan where showing up solo feels normal.')
    expect(buddyPage).toContain('what makes saying yes easier')
