    ...
    <>
      ...
      <main className="container mx-auto px-4 pt-4 pb-32 sm:pt-8 sm:pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          {user && (
            <div className="fixed bottom-0 left-0 right-0 md:relative md:mt-8 bg-white/95 backdrop-blur-lg border-t border-black/[0.06] md:border md:rounded-lg p-3 sm:p-4 shadow-lg md:shadow-none z-40 mb-[96px] md:mb-0 pb-[env(safe-area-inset-bottom,8px)]">
