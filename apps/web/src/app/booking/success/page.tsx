...
function BookingSuccessContent() {
  ...
  if (error) {
    return (
      <main className="min-h-screen bg-background flex items-center justify-center p-6 pt-24">
        <div className="bg-white border border-black/[0.06] shadow-sm rounded-2xl shadow-card p-8 max-w-md w-full text-center">
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background flex items-center justify-center p-6 pt-24">
        <div className="bg-white border border-black/[0.06] shadow-sm rounded-2xl shadow-card p-8 max-w-lg w-full">
          {/* Success Icon */}
          ...
          <div className="relative mb-6" ref={calendarDropdownRef}>
            ...
            {calendarDropdownOpen && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-black/[0.06] shadow-sm rounded-xl shadow-lg border border-border overflow-hidden z-10">
                <button
