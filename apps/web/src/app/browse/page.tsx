    ...
    <div className="min-h-screen bg-[#FFFBF8] text-[#1A1A1A]">
      ...
      <header className="sticky top-0 z-30 bg-[#FFFBF8]/85 backdrop-blur-xl border-b border-black/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/sign-up"
              className="px-4 py-3 bg-[#1A1A1A] text-white text-sm font-semibold rounded-full hover:bg-neutral-800 transition-colors"
            >
              Sign up free
            </Link>
          </div>
      ...
      <div className="border-b border-black/[0.06] sticky top-[65px] z-20 bg-[#FFFBF8]/85 backdrop-blur-xl">
        <div className="relative max-w-6xl mx-auto">
            ...
            {TYPES.map((t) => {
              ...
              return (
                ...
                >
                  ...
                  {t.label}
                  {t.isNew && !active && (
                    <span className="text-[9px] font-bold px-1 py-0.5 rounded bg-emerald-500/20 text-emerald-600 leading-none">
                      NEW
                    </span>
                  )}
                </Link>
          ...
          <div className="sm:hidden pointer-events-none absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-[#FFFBF8] to-transparent" />
        </div>
      </div>
