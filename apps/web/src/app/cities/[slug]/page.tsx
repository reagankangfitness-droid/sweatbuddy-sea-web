    ...
    return (
      <div className="min-h-screen bg-[#0D0D0D] flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <p className="text-[#666666] mb-8">Coming soon to SweatBuddies!</p>
          <Link
            href="/cities"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {upcomingEvents.map((event) => (
                <Link
                  ...
                  className="group block bg-[#0D0D0D] border border-[#333333] rounded-xl p-4 hover:border-[#666666] transition-shadow"
                >
                  <div className="flex items-start gap-3">
                    <div className="w-14 h-14 rounded-lg bg-[#2A2A2A] flex flex-col items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-white group-hover:text-blue-600 transition-colors truncate">
                        {event.title}
                      </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {communities.map((community) => (
                <Link
                  ...
                  className="group block bg-[#0D0D0D] border border-[#333333] rounded-xl p-5 hover:border-[#666666] transition-shadow"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-[#2A2A2A] flex items-center justify-center overflow-hidden flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-white group-hover:text-blue-600 transition-colors truncate">
                        {community.name}
                      </h3>
                      <p className="text-sm text-[#666666] capitalize">{community.category}</p>
                    </div>
                  </div>
