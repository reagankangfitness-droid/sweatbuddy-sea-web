      ...
      <div className="sticky top-0 z-10 border-b border-white/10 bg-[#0B0B0B]/95 backdrop-blur-xl">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h1 className="text-base font-semibold text-white">Create crew profile</h1>
            <div
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-[#666666] mt-1">
                Add the crew profile people can trust before they join a plan.
              </p>
              <div className="mt-4 grid grid-cols-3 gap-2">
                {['Crew profile', 'Join link', 'Event trust'].map((label) => (
                  <div
                    key={label}
