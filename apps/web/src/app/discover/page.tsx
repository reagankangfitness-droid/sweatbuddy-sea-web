  ...
  return (
    ...
    >
      ...
      {session.price > 0 && !isSelected && (
        <div className="absolute -bottom-1 -right-1 bg-neutral-900 text-white text-[9px] font-bold px-1 rounded-full leading-tight border border-white/20">
          ${session.price}
        </div>
      )}
    </div>
        ...
        <button
          ...
          className={`
            ...
            ${active === cat.value
              ...
              : 'bg-neutral-900/90 text-neutral-300 border-neutral-700 hover:border-neutral-500 backdrop-blur'
            }
          `}
        >
          <span>{cat.emoji}</span>
        ...
        <div className="mb-[80px] md:mb-0">
          <div className="bg-neutral-950 border-t border-neutral-800 rounded-t-2xl shadow-2xl">
            ...
            <div className="px-4 pb-6 pt-2">
              ...
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  <Link
                    ...
                    className="text-base font-bold text-neutral-100 leading-snug hover:text-white line-clamp-2 block"
                  >
                    {session.title}
                  </Link>
                </div>
                <button
                  onClick={onClose}
                  className="flex-shrink-0 w-8 h-8 rounded-full bg-neutral-800 flex items-center justify-center hover:bg-neutral-700"
                >
              ...
              {/* Details */}
              <div className="flex flex-col gap-1.5 text-sm text-neutral-400 mb-3">
                {session.startTime && (
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="w-7 h-7 rounded-full overflow-hidden bg-neutral-800 flex-shrink-0">
                ...
                <span className="text-xs text-neutral-400">
                  Hosted by <span className="text-neutral-200 font-medium">{session.host.name ?? 'Someone'}</span>
                </span>
              </div>
              ...
              {!isHost && !session.isFull && (
                <button
                  ...
                  disabled={joining}
                  className="w-full py-3.5 rounded-xl bg-white text-neutral-900 text-sm font-bold hover:bg-neutral-100 disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
                >
                  {joining ? (
              ...
              {session.isFull && (
                <p className="text-center text-sm text-neutral-500 py-3">Session full</p>
              )}
              {isHost && (
                <Link href={`/activities/${session.id}`} className="block">
                  <button className="w-full py-3.5 rounded-xl border border-neutral-700 text-neutral-300 text-sm font-semibold hover:bg-neutral-800 transition-colors">
                    Manage session →
                  </button>
                </Link>
              )}
...
export default function DiscoverPage() {
  ...
  if (loadError || !GOOGLE_MAPS_API_KEY) {
    return (
      <div className="fixed inset-0 bg-neutral-950 flex flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <Link href="/buddy" className="text-white underline text-sm">
  ...
  return (
    <div className="fixed inset-0 bg-neutral-950">
      ...
      <div
        ...
        style={{ top: 0 }}
      >
        <div className="pt-3 pb-2 bg-gradient-to-b from-neutral-950/80 to-transparent backdrop-blur-[2px]">
      ...
      >
        ...
        <button
          onClick={recenter}
          className="w-11 h-11 rounded-full bg-neutral-900/95 backdrop-blur border border-neutral-700 flex items-center justify-center shadow-lg hover:bg-neutral-800 transition-colors"
