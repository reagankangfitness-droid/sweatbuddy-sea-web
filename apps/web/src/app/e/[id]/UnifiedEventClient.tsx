...
export function UnifiedEventClient({ event, initialGoingCount, variant = 'default' }: UnifiedEventClientProps) {
    ...
    return (
      <>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleShare}
            className="flex items-center justify-center w-12 h-12 rounded-xl bg-neutral-800 text-neutral-400 hover:bg-neutral-700 transition-colors flex-shrink-0"
          >
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        onClick={handleShare}
        className="w-full flex items-center justify-center gap-2 py-2.5 bg-neutral-800 hover:bg-neutral-700 rounded-xl text-sm font-medium text-neutral-300 transition-colors"
      >
        {copied ? (
          <>
