...
import { ArrowLeft, MapPin, Calendar, Clock, Users, Share2, Heart, ExternalLink, MessageCircle, Star } from 'lucide-react'
...
export function EventPageClient({ event, familiarFaces = [], communityFollow }: { event: Event; familiarFaces?: FamiliarFace[]; communityFollow?: CommunityFollow }) {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-black/[0.06] p-4 z-40 pb-[env(safe-area-inset-bottom,8px)]">
