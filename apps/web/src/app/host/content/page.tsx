      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-12 pb-28">
        ...
        {showHistory && contentHistory.length > 0 && (
          <div className="mb-6 p-4 bg-neutral-900 rounded-xl border border-neutral-800">
            <h3 className="font-medium text-neutral-100 mb-3">Recent Content</h3>
            <div className="space-y-2 max-h-60 overflow-y-auto">
              {contentHistory.map((item) => (
                <button
                  key={item.id}
                  onClick={() => loadFromHistory(item)}
                  className="w-full text-left p-3 bg-neutral-950 rounded-lg hover:bg-neutral-800 transition-colors"
                >
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {CONTENT_TYPES.map((type) => (
              ...
              >
                <div className={`mb-2 ${selectedType === type.id ? 'text-violet-400' : 'text-neutral-400'}`}>
                  {type.icon}
                </div>
                <p className={`font-medium text-sm ${selectedType === type.id ? 'text-violet-900' : 'text-neutral-100'}`}>
                  {type.label}
                </p>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-2.5 bg-neutral-800 border-0 rounded-xl text-sm text-neutral-100 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-violet-500"
              >
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-4 py-3 bg-neutral-800 border-0 rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-violet-500 placeholder:text-neutral-400"
          />
        </div>
        ...
        {/* Error */}
        {error && (
          <div className="mt-4 p-3 bg-red-950 rounded-xl">
          ...
          <div className="mt-8 p-6 bg-neutral-900 rounded-xl border border-neutral-800">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-neutral-100">Generated Content</h3>
              </div>
              <div className="flex items-center gap-2">
                <button
                  onClick={handleGenerate}
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                    copied
                      ...
                      : 'bg-violet-900 text-violet-700 hover:bg-violet-200'
                  }`}
                >
                  {copied ? (
                    <>
