    ...
    <div className="min-h-screen bg-neutral-900">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-neutral-900/95 backdrop-blur-lg border-b border-neutral-800">
        <div className="flex items-center gap-4 px-4 py-3">
          ...
          <div>
            <div className="h-5 w-32 bg-neutral-700 rounded animate-pulse mb-1" />
      ...
      <main className="pt-24 pb-24 px-4">
        <div className="space-y-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-neutral-950 rounded-2xl border border-neutral-800 shadow-sm flex gap-4 p-4">
              <div className="w-20 h-20 bg-neutral-700 rounded-xl animate-pulse flex-shrink-0" />
              <div className="flex-1 space-y-2">
                <div className="h-3 w-16 bg-neutral-700 rounded animate-pulse" />
                <div className="h-5 w-40 bg-neutral-700 rounded animate-pulse" />
