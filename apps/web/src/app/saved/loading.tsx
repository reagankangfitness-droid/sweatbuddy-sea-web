    ...
    <div className="min-h-screen bg-[#0D0D0D]">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-[#0D0D0D]/95 backdrop-blur-lg border-b border-[#333333]">
        <div className="flex items-center gap-4 px-4 py-3">
          ...
          <div>
            <div className="h-5 w-32 bg-[#2A2A2A] rounded animate-pulse mb-1" />
      ...
      <main className="pt-24 pb-24 px-4">
        <div className="space-y-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-[#1A1A1A] rounded-2xl border border-[#333333] shadow-sm flex gap-4 p-4">
              <div className="w-20 h-20 bg-[#2A2A2A] rounded-xl animate-pulse flex-shrink-0" />
