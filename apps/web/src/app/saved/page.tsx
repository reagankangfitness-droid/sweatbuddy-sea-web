        ...
        <div className="flex gap-2 mt-4">
          ...
          <div className="relative flex-1">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-neutral-950 hover:bg-neutral-950/90 text-neutral-100 py-2.5 px-4 rounded-xl text-sm font-medium transition-colors"
            >
            ...
            {showCalendarMenu && (
              <>
                ...
                />
                <div className="absolute bottom-full left-0 right-0 mb-2 bg-neutral-950 rounded-xl shadow-lg border border-neutral-800 overflow-hidden z-50">
                  <a
                    href={generateCalendarUrl(booking, 'google')}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 px-4 py-3 hover:bg-neutral-800 text-neutral-100 text-sm"
                    onClick={() => setShowCalendarMenu(false)}
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 px-4 py-3 hover:bg-neutral-800 text-neutral-100 text-sm border-t border-neutral-800"
                    onClick={() => setShowCalendarMenu(false)}
                  >
                    <span className="text-lg">🍎</span>
                    Apple Calendar
  ...
  return (
    <div className="grid grid-cols-2 gap-3 mb-8">
      <div className="bg-neutral-950 rounded-xl border border-neutral-800 p-4">
        ...
        <p className="text-2xl font-bold text-neutral-100">{eventsThisMonth}</p>
      ...
      <div className="bg-neutral-950 rounded-xl border border-neutral-800 p-4">
        ...
        <p className="text-2xl font-bold text-neutral-100">{pastEvents.length}</p>
...
function EventCard({ booking, isPast = false }: { booking: BookedEvent; isPast?: boolean }) {
  ...
  return (
    <div className={`bg-neutral-950 rounded-2xl border border-neutral-800 overflow-hidden ${isPast ? 'opacity-70' : ''}`}>
      <Link
        href={`/e/${booking.activity.slug || booking.activity.id}`}
        className="flex"
      >
        {/* Image */}
        <div className="w-20 h-20 flex-shrink-0 bg-neutral-800 relative">
          {booking.activity.imageUrl ? (
            <Image
              src={booking.activity.imageUrl}
              alt={booking.activity.title}
        ...
        <div className="flex-1 p-3 min-w-0">
          ...
          <h4 className="font-medium text-neutral-100 line-clamp-1 text-sm">
            {booking.activity.title}
          </h4>
      ...
      {!isPast && (
        <div className="flex border-t border-neutral-800">
          <button
            onClick={() => openDirections(booking.activity.latitude, booking.activity.longitude, booking.activity.city)}
            className="flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-medium text-neutral-400 hover:bg-neutral-900 transition-colors"
          >
      ...
      <div className="min-h-screen bg-neutral-900">
        ...
        <header className="fixed top-0 left-0 right-0 z-40 bg-neutral-900/95 backdrop-blur-lg border-b border-neutral-800">
          <div className="pt-[env(safe-area-inset-top,0px)]">
            <div className="flex items-center gap-4 px-4 py-3">
              ...
              <h1 className="text-lg font-semibold text-neutral-100">My Schedule</h1>
            </div>
          </div>
        </header>
        ...
        <main className="pt-24 pb-24 px-4">
          <div className="text-center py-12">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-neutral-950 rounded-2xl border border-neutral-800 shadow-sm mb-6">
              <CalendarDays className="w-12 h-12 text-neutral-300" />
            </div>
            <h2 className="text-xl font-bold text-neutral-100 mb-2">See your schedule</h2>
            ...
            <p className="text-sm text-neutral-500 mt-4">
              ...
              <Link href="/sign-up?redirect_url=/saved" className="text-neutral-100 font-medium hover:underline">
                Sign up
              </Link>
            </p>
          </div>
      ...
      <main className="pt-20 pb-24 px-4">
        {isLoading ? (
          <div className="space-y-4 mt-4">
            ...
            <div className="animate-pulse bg-neutral-700 rounded-2xl h-48" />
            {/* Skeleton for stats */}
            <div className="grid grid-cols-2 gap-3">
              <div className="animate-pulse bg-neutral-950 rounded-xl h-24 border border-neutral-800" />
              <div className="animate-pulse bg-neutral-950 rounded-xl h-24 border border-neutral-800" />
            </div>
            {/* Skeleton for events */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2].map((col) => (
                <div key={col} className="space-y-3">
                  ...
                  {[1, 2].map((i) => (
                    <div key={i} className="animate-pulse bg-neutral-950 rounded-xl border border-neutral-800 h-24" />
                  ))}
                </div>
              ))}
            </div>
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-lg font-semibold text-neutral-100 mb-2">Failed to load schedule</h2>
          ...
          <div className="text-center py-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-neutral-950 rounded-2xl border border-neutral-800 shadow-sm mb-6">
              <CalendarDays className="w-10 h-10 text-neutral-300" />
            </div>
            <h2 className="text-lg font-semibold text-neutral-100 mb-2">No events yet</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    <h2 className="text-base font-semibold text-neutral-100">Upcoming</h2>
                    <p className="text-xs text-neutral-500">{upcomingEvents.length} experiences</p>
                  </div>
                </div>

                {upcomingEvents.length === 0 ? (
                  <div className="bg-neutral-950 rounded-xl border border-neutral-800 p-6 text-center">
                  ...
                  <div className="space-y-3">
                    ...
                    {upcomingEvents.length === 1 && (
                      <div className="bg-neutral-950 rounded-xl border border-neutral-800 p-4 text-center">
                        <p className="text-sm text-neutral-500">
                          Your next experience is shown above
                        </p>
                        <Link
                          href="/"
                          className="text-sm font-medium text-neutral-100 hover:underline mt-2 inline-block"
                        >
              ...
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    <h2 className="text-base font-semibold text-neutral-100">Past Events</h2>
                ...
                {pastEvents.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    ...
                    {pastEvents.length > 10 && (
                      <Link
                        href="/my-bookings"
                        className="block text-center py-3 text-sm font-medium text-neutral-400 hover:text-neutral-100 transition-colors"
                      >
