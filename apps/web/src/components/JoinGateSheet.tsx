      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-50 bg-[#18181B] rounded-t-2xl shadow-2xl max-h-[92vh] flex flex-col"
          >
            {/* Drag handle */}
            ...
            <div className="overflow-y-auto flex-1 px-5 pb-[env(safe-area-inset-bottom,20px)]">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-1 py-3 rounded-xl transition-all ${
                      selected.includes(i.slug)
                        ? 'bg-[#10B981] text-white shadow-md scale-[1.04]'
                        : 'bg-[#27272A] border border-white/[0.06] text-[#A1A1AA] hover:border-white/[0.12]'
                    }`}
                  >
              ...
              {/* Fitness level */}
              <div className="mb-6">
                <p className="text-xs font-semibold text-[#FAFAFA] mb-2">
                  Fitness level
                </p>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-full bg-gradient-to-r from-[#10B981] to-[#059669] text-white text-sm font-semibold disabled:opacity-30 transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#10B981]/20"
              >
                {saving ? (
                  <>
              ...
              {selected.length === 0 && (
                <p className="text-center text-[11px] text-[#71717A] mt-2 mb-1">
