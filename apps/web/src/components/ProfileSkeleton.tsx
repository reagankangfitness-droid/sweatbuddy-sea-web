  ...
  return (
    <div className="min-h-screen bg-neutral-900 animate-pulse">
      ...
      <main className="max-w-lg mx-auto px-4 py-8">
        {/* Profile Card */}
        <div className="bg-neutral-950 rounded-2xl p-6 shadow-sm border border-neutral-800 mb-6">
          {/* Avatar & Name */}
          <div className="flex items-center gap-4 mb-6">
            <div className="w-20 h-20 bg-neutral-700 rounded-full" />
            <div className="flex-1">
              <div className="h-6 w-40 bg-neutral-700 rounded mb-2" />
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 py-4 border-t border-b border-neutral-800">
            {[1, 2, 3].map((i) => (
              <div key={i} className="text-center">
                <div className="h-6 w-8 bg-neutral-700 rounded mx-auto mb-1" />
                <div className="h-3 w-16 bg-neutral-800 rounded mx-auto" />
              </div>
            ))}
          </div>
        ...
        {/* Menu Items */}
        <div className="bg-neutral-950 rounded-2xl shadow-sm border border-neutral-800 overflow-hidden">
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="flex items-center gap-4 p-4 border-b border-neutral-800 last:border-0"
            >
              <div className="w-10 h-10 bg-neutral-800 rounded-xl" />
              <div className="flex-1">
                <div className="h-5 w-28 bg-neutral-700 rounded mb-1" />
