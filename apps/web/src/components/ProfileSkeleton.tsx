        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-neutral-200 mb-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="h-4 w-48 bg-neutral-100 rounded mb-2" />
              <div className="h-5 w-20 bg-emerald-100 rounded-full" />
            </div>
          </div>

          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 py-4 border-t border-b border-neutral-100">
            {[1, 2, 3].map((i) => (
              <div key={i} className="text-center">
                <div className="h-6 w-8 bg-neutral-200 rounded mx-auto mb-1" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden">
          {[1, 2, 3, 4, 5].map((i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="h-5 w-28 bg-neutral-200 rounded mb-1" />
