  ...
  return (
    <div className={cn('bg-white rounded-2xl border border-neutral-200 p-6', className)}>
      ...
      <div className="flex gap-4 mb-5">
        ...
        <div>
          <h3 className="text-lg font-semibold text-neutral-900">Earnings Calculator</h3>
          <p className="text-sm text-neutral-500">See how much you&apos;ll earn per activity</p>
        </div>
      </div>
      ...
      {showCalculator && (
        <div className="grid grid-cols-2 gap-4 mb-6 max-[480px]:grid-cols-1">
          <div>
            ...
            <div className="flex items-center border border-neutral-200 rounded-xl overflow-hidden focus-within:border-[#0025CC] focus-within:ring-2 focus-within:ring-[#0025CC]/10">
              <span className="flex items-center justify-center px-3.5 bg-neutral-100 text-neutral-500 text-sm font-medium h-12 border-r border-neutral-200">
                S$
              </span>
              <input
                type="number"
          ...
          <div>
            ...
            <div className="flex items-center border border-neutral-200 rounded-xl overflow-hidden focus-within:border-[#0025CC] focus-within:ring-2 focus-within:ring-[#0025CC]/10">
              <span className="flex items-center justify-center px-3.5 bg-neutral-100 text-neutral-500 h-12 border-r border-neutral-200">
                <Users size={16} />
              </span>
              <input
                type="number"
      ...
      <div className="grid grid-cols-[1.2fr_1fr] gap-4 mb-6 max-[480px]:grid-cols-1">
        ...
        {/* What attendees pay */}
        <div className="bg-neutral-100 rounded-2xl px-5 py-6 text-center">
          ...
          <p className="text-[13px] text-neutral-500 mt-1.5">per person</p>
        </div>
      </div>

      {/* How it works breakdown */}
      <div className="bg-neutral-50 rounded-2xl p-5 mb-5">
        <div className="flex justify-between items-center mb-5 flex-wrap gap-2.5">
          <h4 className="text-[15px] font-semibold text-neutral-900">How it works</h4>
        ...
        <div className="flex flex-col gap-3">
          {/* Step 1 */}
          <div className="flex items-center gap-3.5 p-3 bg-white rounded-xl border border-neutral-200">
            ...
            <div>
              <p className="text-sm font-medium text-neutral-900">You set your price</p>
              <p className="text-[13px] text-neutral-500">{formatCurrency(ticketPrice)} per ticket</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5 p-3 bg-white rounded-xl border border-neutral-200">
            ...
            <div>
              <p className="text-sm font-medium text-neutral-900">We add a small service fee</p>
          ...
          <div className="flex items-center gap-3.5 p-3 bg-white rounded-xl border border-neutral-200">
            ...
            <div>
              <p className="text-sm font-medium text-neutral-900">Attendees pay total</p>
              <p className="text-[13px] text-neutral-500">
          ...
          <div className="flex items-center gap-3.5 p-3 bg-emerald-100 rounded-xl border border-emerald-200">
            ...
            <div>
              <p className="text-sm font-medium text-neutral-900">You receive 100%</p>
              <p className="text-[13px] text-neutral-500">
      ...
      {/* Explanation */}
      <div className="flex items-start gap-2.5 text-[13px] text-neutral-600 leading-relaxed p-4 bg-blue-50 border border-blue-100 rounded-xl mb-6">
