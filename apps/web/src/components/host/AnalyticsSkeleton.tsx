  ...
  return (
    <div className="min-h-screen bg-neutral-950 animate-pulse">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        {/* Title */}
        <div className="mb-8">
          <div className="h-8 w-40 bg-neutral-700 rounded mb-2" />
          <div className="h-5 w-64 bg-neutral-800 rounded" />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 mb-8">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-neutral-800 rounded-xl p-4">
              ...
              <div className="h-8 w-12 bg-neutral-700 rounded mb-1" />
              <div className="h-3 w-10 bg-green-900 rounded" />
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-neutral-900 rounded-xl p-5 border border-neutral-800">
            ...
            <div className="h-64 bg-neutral-800 rounded-lg flex items-end justify-around px-4 pb-4">
              {[40, 65, 45, 80, 55, 70, 90, 60, 75, 50, 85, 95].map((h, i) => (
                <div
                  key={i}
                  className="w-4 sm:w-6 bg-neutral-700 rounded-t"
                  style={{ height: `${h}%` }}
                />
              ))}
            </div>
          ...
          {/* Show-up Rate Chart */}
          <div className="bg-neutral-900 rounded-xl p-5 border border-neutral-800">
            <div className="h-5 w-36 bg-neutral-700 rounded mb-4" />
            <div className="h-64 bg-neutral-800 rounded-lg relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-neutral-900 rounded-xl p-5 border border-neutral-800">
            ...
            <div className="h-48 flex items-center justify-center">
              <div className="w-40 h-40 rounded-full border-8 border-neutral-800 relative">
                <div className="absolute inset-4 rounded-full border-8 border-neutral-800" />
              </div>
            </div>
        ...
        <div className="bg-neutral-900 rounded-xl p-5 border border-neutral-800">
          ...
          <div className="space-y-3">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center gap-4 p-3 bg-neutral-950 rounded-lg">
                <div className="w-6 h-6 bg-neutral-700 rounded-full" />
                <div className="flex-1">
                  <div className="h-4 w-48 bg-neutral-700 rounded mb-1" />
