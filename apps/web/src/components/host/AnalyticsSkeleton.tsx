      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 mb-8">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-neutral-100 rounded-xl p-4">
              ...
              <div className="h-3 w-10 bg-green-100 rounded" />
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-neutral-50 rounded-xl p-5 border border-neutral-200">
            ...
            <div className="h-64 bg-neutral-100 rounded-lg flex items-end justify-around px-4 pb-4">
              {[40, 65, 45, 80, 55, 70, 90, 60, 75, 50, 85, 95].map((h, i) => (
                <div
                  key={i}
                  className="w-4 sm:w-6 bg-neutral-200 rounded-t"
                  style={{ height: `${h}%` }}
                />
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-neutral-50 rounded-xl p-5 border border-neutral-200">
            ...
            <div className="h-48 flex items-center justify-center">
              <div className="w-40 h-40 rounded-full border-8 border-neutral-200 relative">
                <div className="absolute inset-4 rounded-full border-8 border-neutral-100" />
              </div>
            </div>
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center gap-4 p-3 bg-white rounded-lg">
                ...
                <div className="flex-1">
                  <div className="h-4 w-48 bg-neutral-200 rounded mb-1" />
