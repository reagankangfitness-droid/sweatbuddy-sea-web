  ...
  return (
    <div className="min-h-screen bg-neutral-950 animate-pulse">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        {/* Title */}
        <div className="mb-6">
          <div className="h-8 w-48 bg-neutral-700 rounded mb-2" />
          <div className="h-5 w-72 bg-neutral-800 rounded" />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-neutral-800 rounded-xl p-4">
              <div className="h-8 w-12 bg-neutral-700 rounded mb-2" />
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <div className="flex-1 h-10 bg-neutral-800 rounded-lg" />
        ...
        <div className="border border-neutral-800 rounded-xl overflow-hidden">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <div
              key={i}
              className="p-4 border-b border-neutral-800 last:border-0"
            >
