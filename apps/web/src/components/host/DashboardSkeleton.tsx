  ...
  return (
    <div className="min-h-screen bg-white animate-pulse">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        {/* Welcome Skeleton */}
        <div className="mb-2">
          <div className="h-7 w-72 bg-neutral-200 rounded mb-2" />
          <div className="h-5 w-56 bg-neutral-100 rounded" />
        </div>

        {/* Pulse Card Skeleton */}
        <div className="bg-gradient-to-br from-violet-50 to-indigo-50 rounded-xl border border-violet-200 p-4 sm:p-5 mb-6 sm:mb-8 mt-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4 mb-4 sm:mb-6">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className={`bg-neutral-100 rounded-xl p-4 sm:p-6 ${i === 3 ? 'col-span-2 sm:col-span-1' : ''}`}
            >
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-2 mb-4 sm:mb-6">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className={`h-9 rounded-full ${i === 1 ? 'w-20 bg-neutral-900' : 'w-24 bg-neutral-100'}`}
                />
              ))}
            </div>
              ...
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="p-4">
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-neutral-200 rounded-lg flex-shrink-0" />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div>
              ...
              <div className="border border-neutral-200 rounded-xl bg-white">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="p-3 border-b border-neutral-100 last:border-0">
                    <div className="flex items-center gap-3">
