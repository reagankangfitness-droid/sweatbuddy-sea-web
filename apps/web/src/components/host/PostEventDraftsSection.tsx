  ...
  return (
    <>
      <div className="mb-4 sm:mb-6">
        <div className="p-3 sm:p-4 bg-violet-50 border border-violet-800 rounded-xl">
          ...
          <div className="space-y-2">
            {drafts.map((draft) => (
              <div
                key={draft.id}
                className="flex items-center gap-3 p-2.5 bg-neutral-950 rounded-lg border border-violet-100"
              >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-violet-700 bg-violet-900 hover:bg-violet-200 rounded-full transition-colors whitespace-nowrap"
                >
      ...
      {modal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative w-full max-w-lg bg-neutral-950 rounded-2xl shadow-xl overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-800">
              ...
              <button
                onClick={() => !modal.isSending && !modal.isSaving && setModal(null)}
                className="p-1 text-neutral-400 hover:text-neutral-400 transition-colors"
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-neutral-800 rounded-lg bg-neutral-950 text-neutral-100 focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-neutral-400 mb-1.5">
                    ...
                    <textarea
                      ...
                      rows={6}
                      className="w-full px-3 py-2 text-sm border border-neutral-800 rounded-lg bg-neutral-950 text-neutral-100 focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none resize-none"
                    />
                  ...
                  {modal.error && (
                    <p className="text-xs text-red-400">{modal.error}</p>
                  )}
                </>
              )}
            </div>
