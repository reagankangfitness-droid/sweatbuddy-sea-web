  ...
  return (
    <>
      <div className="mb-4 sm:mb-6">
        <div className="p-3 sm:p-4 bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl">
          <h2 className="text-sm sm:text-base font-semibold text-violet-900 dark:text-violet-100 mb-2 flex items-center gap-2">
          ...
          <div className="space-y-2">
            {drafts.map((draft) => (
              <div
                key={draft.id}
                className="flex items-center gap-3 p-2.5 bg-white dark:bg-neutral-900 rounded-lg border border-violet-100 dark:border-violet-900/50"
              >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-violet-700 dark:text-violet-300 bg-violet-100 dark:bg-violet-800/40 hover:bg-violet-200 dark:hover:bg-violet-800/60 rounded-full transition-colors whitespace-nowrap"
                >
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-neutral-200 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-1.5">
                    ...
                    <textarea
                      ...
                      rows={6}
                      className="w-full px-3 py-2 text-sm border border-neutral-200 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none resize-none"
                    />
