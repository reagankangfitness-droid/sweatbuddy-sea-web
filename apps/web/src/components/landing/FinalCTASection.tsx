...
export function FinalCTASection() {
  return (
    <section id="cta" className="py-24 pb-32 px-5 text-center relative overflow-hidden">
      ...
      />
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-neutral-950/90 z-[1]" />

      <div className="relative z-[2]">
        <ScrollReveal>
          <div className="font-sans text-label tracking-[0.15em] uppercase text-neutral-400 mb-4">
            Ready?
          </div>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2.5 bg-white text-neutral-900 px-12 py-[18px] rounded-full font-sans font-bold text-heading-sm transition-all duration-300 hover:bg-neutral-100 hover:-translate-y-1 shadow-md hover:shadow-lg"
            >
              Find Events →
            </Link>
            <Link
