    ...
    <div className={`relative h-full w-full overflow-hidden bg-[#1C211F] ${className ?? ''}`}>
      ...
      <div className="absolute inset-x-3 top-3 z-[4] flex items-start justify-between gap-2">
        ...
        <button
          ...
          className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/15 bg-black/45 font-mono text-[10px] font-black uppercase tracking-wide text-white/72 backdrop-blur transition-colors hover:border-[#63FF8F] hover:text-[#63FF8F] sm:w-auto sm:px-4 sm:text-[11px]"
        >
