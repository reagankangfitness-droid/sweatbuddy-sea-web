...
export const colors = {
  ...
  accent: {
    yellow: '#FFD230',         // Golden Yellow
    yellowHover: '#E6BD2B',    // Darker golden for hover states
    yellowDark: '#CC9900',     // Dark gold
    yellowLight: 'rgba(255, 210, 48, 0.15)',
    yellowText: '#222222',     // Dark text on yellow
  },
