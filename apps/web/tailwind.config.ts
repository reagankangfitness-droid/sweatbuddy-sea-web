  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'xs': '0 1px 2px rgba(0, 37, 204, 0.05)',
        'sm': '0 1px 3px rgba(0, 37, 204, 0.08)',
        'card': '0 2px 8px rgba(0, 37, 204, 0.08)',
        'card-hover': '0 12px 32px rgba(0, 37, 204, 0.12)',
        'premium': '0 8px 20px rgba(0, 37, 204, 0.10)',
        'premium-hover': '0 16px 40px rgba(0, 37, 204, 0.14)',
        'soft': '0 2px 12px rgba(0, 37, 204, 0.06)',
        'lifted': '0 4px 16px rgba(0, 37, 204, 0.08)',
        'button-glow': '0 2px 4px rgba(0, 37, 204, 0.2)',
        'button-glow-hover': '0 4px 12px rgba(0, 37, 204, 0.3)',
        'header-scroll': '0 2px 8px rgba(0, 0, 0, 0.08)',
        'glass': '0 8px 32px rgba(0, 37, 204, 0.10)',
